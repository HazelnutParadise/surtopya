  ...
  return (
    <div 
      ...
      style={{ 
        ...
        fontFamily: activeTheme.fontFamily === 'serif' ? 'serif' : activeTheme.fontFamily === 'mono' ? 'monospace' : activeTheme.fontFamily === 'comic' ? '"Comic Sans MS", cursive, sans-serif' : 'inherit'
      }}
    >
