...
var agentEndpointDocs = []agentEndpointDoc{
	...
	{Method: "GET", Path: "/api/v1/agent-admin/deid", OpenAPIPath: "/deid", Purpose: "de-identification workflow usage and queue summary", Summary: "Get de-identification usage index", Permission: "deid.read"},
	{Method: "POST", Path: "/api/v1/agent-admin/deid/sessions/start", OpenAPIPath: "/deid/sessions/start", Purpose: "start next pending de-identification session", Summary: "Start de-identification session", Permission: "deid.write"},
	{Method: "GET", Path: "/api/v1/agent-admin/deid/sessions/:session_id", OpenAPIPath: "/deid/sessions/{session_id}", Purpose: "resume de-identification session", Summary: "Get de-identification session", Permission: "deid.read"},
	{Method: "POST", Path: "/api/v1/agent-admin/deid/sessions/:session_id/chunks/:chunk_index/annotate", OpenAPIPath: "/deid/sessions/{session_id}/chunks/{chunk_index}/annotate", Purpose: "annotate current chunk sensitive cells", Summary: "Annotate de-identification chunk", Permission: "deid.write"},
